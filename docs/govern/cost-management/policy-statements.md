...
description: Rozhraní pro přijetí do cloudu pro Azure použijte k získání ukázkových příkazů zásad Cost Management, které vám pomůžou s koncepty zásad.
