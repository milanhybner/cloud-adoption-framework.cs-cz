...
|Je podporováno blokování starších verzí protokolů?|[Ano](https://docs.microsoft.com/azure/active-directory/conditional-access/howto-baseline-protect-legacy-auth)|[Ano](https://docs.microsoft.com/azure/active-directory/conditional-access/howto-baseline-protect-legacy-auth)|[Ano](/windows-server/identity/ad-fs/operations/access-control-policies-w2k12)|
