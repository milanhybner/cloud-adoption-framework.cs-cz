...
- **Konec služby:** Rychlé přesunutí instance SQL Server, aby se předešlo problémům s koncovými službami, je použití této příručky mimo standardní úsilí při migraci.
...
|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|
|SQL-01|Základní aplikace|2016|Klíčové|Vysoce důvěrné|40|–|–|–|Ano|3|
|SQL-02|Základní aplikace|2016|Klíčové|Vysoce důvěrné|40|–|–|–|Ano|3|
|SQL-03|Základní aplikace|2016|Klíčové|Vysoce důvěrné|40|–|–|–|Ano|3|
|SQL – 04|BI|2012|Vysoký|CZK|6|–|Přehled|Ano – multidimenzionální datová krychle|Ne|1\. místo|
|SQL-05|Integrace|2008 R2|Nízká|Obecné|20|Ano|–|–|Ne|1\. místo|
...
|---------|---------|---------|---------|---------|---------|---------|
|SQL-01|DB-1|Klíčové|Vysoce důvěrné|Kompatibility|–|Azure SQL Database|
|SQL-01|DB-2|Vysoký|Přehled|Je vyžadována Změna schématu.|Změny implementovány|Azure SQL Database|
|SQL-01|DB-1|Vysoký|Obecné|Kompatibility|–|Spravovaná instance Azure SQL|
|SQL-01|DB-1|Nízká|Vysoce důvěrné|Je vyžadována Změna schématu.|Naplánované změny|Spravovaná instance Azure SQL|
|SQL-01|DB-1|Klíčové|Obecné|Kompatibility|–|Spravovaná instance Azure SQL|
|SQL-01|DB-2|Vysoký|Přehled|Kompatibility|–|Azure SQL Database|
...
|---------|---------|
|[Azure Database Migration Service](/sql/dma/dma-overview)|Podporuje online migrace (minimální výpadky) a offline (jednou) škálování na Azure SQL Database spravovanou instanci. Podporuje migraci z: SQL Server 2005, SQL Server 2008 a SQL Server 2008 R2, SQL Server 2012, SQL Server 2014, SQL Server 2016 a SQL Server 2017.|
...
|[Hromadné načtení](/sql/t-sql/statements/bulk-insert-transact-sql)|Použijte hromadnou zátěž do Azure SQL Database spravované instance pro data uložená v: SQL Server 2005, SQL Server 2008 a SQL Server 2008 R2, SQL Server 2012, SQL Server 2014, SQL Server 2016 a SQL Server 2017.|
...
|Zdroj  |Výběr cílového umístění  |Nástroj  |Typ migrace  |Pokyny  |
|---------|---------|---------|---------|---------|
|Služba SSIS (SQL Server Integration Services)|Prostředí Azure Data Factory Integration runtime|Azure Data Factory|Stav|[Kurz](https://docs.microsoft.com/azure/data-factory/create-azure-ssis-integration-runtime)|
|SQL Server Analysis Services – tabulkový model|Azure Analysis Services|SQL Server Data Tools|Stav|[Kurz](https://docs.microsoft.com/azure/analysis-services/analysis-services-deploy)|
|SQL Server Reporting Services|Server sestav Power BI|Power BI|Stav|[Kurz](/power-bi/report-server/migrate-report-server)|
