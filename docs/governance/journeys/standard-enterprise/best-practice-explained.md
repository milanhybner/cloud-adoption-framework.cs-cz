---
title: 'Standardní podniková příručka: Vysvětlení doporučených pokynů'
...
Rozhodnutí týkající se protokolování a vytváření sestav určují, jak jsou strukturovaná data protokolu úložiště a jak jsou strukturované nástroje pro monitorování a vytváření sestav, které udržují pracovníky IT informace o provozním stavu. V tomto mluveném komentáři navrhneme [model nativního cloudu](../../../decision-guides/log-and-report/index.md#cloud-native)* * pro protokolování a vytváření sestav.
