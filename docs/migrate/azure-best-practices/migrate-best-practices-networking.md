...
## <a name="best-practice-plan-ip-addressing"></a>Osvědčený postup: Naplánování IP adresování
...
- [Přečtěte si](../../ready/considerations/naming-and-tagging.md) o pravidlech a omezeních pro pojmenování DNS.
...
- Ve své architektuře migrace můžete naplánovat a vytvořit vysokou dostupnost tím, že sdružíte výpočetní prostředky, úložiště, sítě a datové prostředky v rámci zóny a budete je replikovat do jiných zón. Služby Azure, které podporují zóny dostupnosti, spadají do dvou kategorií:
  - Služby oblastí: přidružíte prostředek ke konkrétní zóně. Třeba virtuální počítače, spravované disky, IP adresy.
  - Redundantní služby v zóně: prostředek se automaticky replikuje mezi zónami. Třeba zónově redundantní úložiště, Azure SQL Database.
...
## <a name="best-practice-implement-a-highly-available-site-to-site-vpn"></a>Osvědčený postup: implementace sítě VPN typu Site-to-site s vysokou dostupností
...
### <a name="best-practice-configure-a-gateway-for-vpn-gateways"></a>Osvědčené postupy: Konfigurace brány pro brány VPN
...
### <a name="best-practice-optimize-expressroute-routing-with-bgp-communities"></a>Osvědčený postup: optimalizace směrování ExpressRoute s využitím komunit protokolu BGP
...
## <a name="best-practice-implement-an-azure-perimeter-network"></a>Osvědčené postupy: implementace hraniční sítě Azure
...
## <a name="best-practice-filter-vnet-traffic-with-nsgs"></a>Osvědčený postup: filtrování provozu virtuální sítě pomocí skupin zabezpečení sítě
...
--- | --- | ---
Allow-HTTP-Inbound-Internet | Povoluje provoz z internetu na webové servery. Výchozí pravidlo zabezpečení DenyAllInbound odepírá příchozí provoz z internetu, takže pro skupiny zabezpečení aplikace AsgLogic a AsgDb není potřeba žádné další pravidlo. | Priorita: 100<br/><br/> Zdroj: internet<br/><br/> Zdrojový port: *<br/><br/> Cíl: AsgWeb<br/><br/> Cílový port: 80<br/><br/> Protokol: TCP<br/><br/> Přístup: umožňuje.
...
Allow-Database-BusinessLogic | Povoluje provoz ze skupiny zabezpečení aplikace AsgLogic do skupiny zabezpečení aplikace AsgDb. Priorita pro toto pravidlo je vyšší než pro pravidlo Deny-Database-All a zpracovává se před ním, takže se povolí provoz ze skupiny zabezpečení aplikace AsgLogic a veškerý ostatní provoz se zablokuje. | Priorita: 110<br/><br/> Zdroj: AsgLogic<br/><br/> Zdrojový port: *<br/><br/> Cíl: AsgDb<br/><br/> Cílový port: 1433<br/><br/> Protokol: TCP<br/><br/> Přístup: umožňuje.
...
## <a name="best-practice-implement-firewalls-and-nvas-in-hub-networks"></a>Osvědčený postup: implementace bran firewall a síťová virtuální zařízení v sítích centra
