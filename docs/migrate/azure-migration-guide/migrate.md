...
description: Tento návod vám pomůže zahájit migraci vašeho prostředí identifikací vhodných nástrojů pro dosažení stavu „hotovo“, včetně nativních nástrojů, nástrojů třetích stran a nástrojů pro správu projektů.
author: matticusau
ms.author: mlavery
ms.date: 08/08/2019
ms.topic: guide
