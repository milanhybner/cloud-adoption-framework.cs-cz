...
Další informace o používání značek najdete v [Centru architektury Azure v zásadách vytváření názvů pro prostředky Azure](../../ready/azure-best-practices/naming-and-tagging.md#metadata-tags).
