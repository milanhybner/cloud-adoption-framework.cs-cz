...
description: Pomocí architektury přechodu na cloud pro Azure můžete vyhodnotit vhodnost vašeho prostředí pro migraci a uvažované metody.
author: matticusau
ms.author: mlavery
ms.date: 02/25/2020
ms.topic: guide
