...
![Mapování dovedností na role IT v cloudovém hostovaném prostředí](../_images/skills-guidance.png)
...
- **Přechod:** Dovednosti při přijetí jsou zarovnané na různé technické úsilí:
...
- **Jednat** Dovednosti související s operačním modelem pro přijetí v cloudu jsou zarovnané na různé příležitosti, které vám pomůžou získat dovednosti:
  - **Bude** Získejte dovednosti potřebné k řízení cloudového prostředí.
  - **Správa:** Získejte dovednosti potřebné ke správě cloudového prostředí.
